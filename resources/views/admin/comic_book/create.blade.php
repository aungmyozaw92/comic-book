@extends('admin.layout.master', ['activePage' => 'comic_book', 'titlePage' => __('New Comic Book')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('comic_books.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('New Comic Book') }}</h4>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-7">
                          <div class="form-group{{ $errors->has('artist') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('artist') ? ' is-invalid' : '' }}" name="artist" id="input-artist" type="text" placeholder="{{ __('Artist') }}" value="{{ old('artist') }}" required />
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-7">
                          <div class="form-group{{ $errors->has('rating') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('rating') ? ' is-invalid' : '' }}" name="rating" id="input-rating" type="text" placeholder="{{ __('Rating') }}" value="{{ old('rating') }}" required />
                          ...
                          <div class="col-sm-10">
                              <div class="form-check form-check-inline">
                                  <label class="form-check-label">
                                      <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" name="is_featured"> Is Featured
                              ...
                              <div class="form-check form-check-inline">
                                  <label class="form-check-label">
                                      <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="1" name="is_recommend"> Is Recommend
                                      <span class="form-check-sign">
                                          <span class="check"></span>
                                      </span>
                                  </label>
                              ...
                              <div class="form-check form-check-inline">
                                  <label class="form-check-label">
                                      <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="1" name="is_banner"> Is Banner
                                      <span class="form-check-sign">
                                          <span class="check"></span>
                                      </span>
                                  </label>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                            <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" cols="30" rows="10" aria-required="true">{{ old('description') }}</textarea>
